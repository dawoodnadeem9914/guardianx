...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-teal-strong dark:data-[state=checked]:bg-teal",
      "data-[state=unchecked]:bg-background-alt data-[state=unchecked]:border-border-strong",
      className
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        ...
        "dark:data-[state=checked]:bg-[#04201c]"
      )}
    />
  </SwitchPrimitive.Root>
));
